                            ...
                            <div class="item {{ $i == 0 ? 'active' : '' }}">
                                ...
                                <picture>
                                    @if($photo = \App\Helpers\Common::getWebpByImage($img))
                                        <source srcset="{{ \App\Helpers\Common::getImage($img) }}" type="image/webp">
                                        <source srcset="{{ \App\Helpers\Common::getImage($img) }}" type="image/pjp2">
                                    @endif
                                    <img src="{{ \App\Helpers\Common::getImage($img) }}" alt="banner image{{$i}}">
                                </picture>
                            </div>
                        @endforeach
                    </div>
                    <div class="slider">
                        @foreach($product->galleries as $k => $image)
                            <div class="item {{ $k == 0 ? 'active' : '' }}">
                                ...
                                @endif
                                <picture>
                                    @if($photo = \App\Helpers\Common::getWebpByImage($image))
                                        <source srcset="{{ \App\Helpers\Common::getImage($image) }}" type="image/webp">
                                        <source srcset="{{ \App\Helpers\Common::getImage($image) }}" type="image/pjp2">
                                    @endif
                                    <img src="{{ \App\Helpers\Common::getImage($image) }}" alt="slider image{{$k}}">
                                </picture>
                            </div>
                        @endforeach
                    </div>
