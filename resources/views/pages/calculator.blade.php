                ...
                <div class="block1_right">
                    <div class="box">
                        <div class="item">
                            ...
                            <div class="item_desc kirpichShtuk">34 567</div>
                        </div>
                        <div class="item">
                            <div class="item_title">{{ __('Количество паллет, шт:') }}</div>
                            <div class="item_desc kirpichPalet">115</div>
                        </div>
                        <div class="item">
                            <div class="item_title">{{ __('Вес, кг:') }}</div>
                            <div class="item_desc kirpichWess">103 701</div>
                        </div>
                        <div class="item">
                            <div class="item_title">{{ __('Итоговая стоимость, тенге:') }}</div>
                            <div class="item_desc kirpichAllCost">123 456 123</div>
                        </div>
